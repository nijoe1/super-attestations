...
export declare namespace RegisteredEvent {
    type InputTuple = [uid: BytesLike, registerer: AddressLike];
    type OutputTuple = [uid: string, registerer: string];
...
export interface SchemaRegistry extends BaseContract {
    ...
    filters: {
        "Registered(bytes32,address)": TypedContractEvent<RegisteredEvent.InputTuple, RegisteredEvent.OutputTuple, RegisteredEvent.OutputObject>;
