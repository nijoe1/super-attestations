...
export interface TestEIP712ProxyInterface extends Interface {
    getFunction(nameOrSignature: "attestByDelegation" | "eip712Domain" | "getAttestTypeHash" | "getAttester" | "getDomainSeparator" | "getEAS" | "getName" | "getRevokeTypeHash" | "multiAttestByDelegation" | "multiRevokeByDelegation" | "revokeByDelegation" | "verifyAttest" | "verifyRevoke" | "version"): FunctionFragment;
    ...
    encodeFunctionData(functionFragment: "verifyAttest", values: [DelegatedProxyAttestationRequestStruct]): string;
    encodeFunctionData(functionFragment: "verifyRevoke", values: [DelegatedProxyRevocationRequestStruct]): string;
...
//# sourceMappingURL=TestEIP712Proxy.d.ts.map