...
var DocumentNav = function () {
    var _a = (0, react_1.useContext)(DocViewerProvider_1.DocViewerContext), _b = _a.state, currentDocument = _b.currentDocument, currentFileNo = _b.currentFileNo, documents = _b.documents, dispatch = _a.dispatch;
    ...
    return (react_1.default.createElement(Container, { id: "doc-nav" },
        react_1.default.createElement("p", { id: "doc-nav-info" }, t("documentNavInfo", {
