...
var TransactionExpiredBlockheightExceededError = /*#__PURE__*/function (_Error) {
  _inherits__default.default(TransactionExpiredBlockheightExceededError, _Error);
  ...
  function TransactionExpiredBlockheightExceededError(signature) {
    var _this;
    _classCallCheck__default.default(this, TransactionExpiredBlockheightExceededError);
    _this = _super.call(this, "Signature ".concat(signature, " has expired: block height exceeded."));
    _this.signature = void 0;
    _this.signature = signature;
    return _this;
  }
  return _createClass__default.default(TransactionExpiredBlockheightExceededError);
}( /*#__PURE__*/_wrapNativeSuper__default.default(Error));
Object.defineProperty(TransactionExpiredBlockheightExceededError.prototype, 'name', {
  value: 'TransactionExpiredBlockheightExceededError'
});
var TransactionExpiredTimeoutError = /*#__PURE__*/function (_Error2) {
  _inherits__default.default(TransactionExpiredTimeoutError, _Error2);
  ...
  function TransactionExpiredTimeoutError(signature, timeoutSeconds) {
    var _this2;
    _classCallCheck__default.default(this, TransactionExpiredTimeoutError);
  ...
  return _createClass__default.default(TransactionExpiredTimeoutError);
}( /*#__PURE__*/_wrapNativeSuper__default.default(Error));
Object.defineProperty(TransactionExpiredTimeoutError.prototype, 'name', {
  value: 'TransactionExpiredTimeoutError'
});
var TransactionExpiredNonceInvalidError = /*#__PURE__*/function (_Error3) {
  _inherits__default.default(TransactionExpiredNonceInvalidError, _Error3);
  var _super3 = _createSuper$2(TransactionExpiredNonceInvalidError);
  function TransactionExpiredNonceInvalidError(signature) {
    var _this3;
    _classCallCheck__default.default(this, TransactionExpiredNonceInvalidError);
  ...
  return _createClass__default.default(TransactionExpiredNonceInvalidError);
}( /*#__PURE__*/_wrapNativeSuper__default.default(Error));
...
var MessageAccountKeys = /*#__PURE__*/function () {
  function MessageAccountKeys(staticAccountKeys, accountKeysFromLookups) {
    _classCallCheck__default.default(this, MessageAccountKeys);
    this.staticAccountKeys = void 0;
    this.accountKeysFromLookups = void 0;
    this.staticAccountKeys = staticAccountKeys;
    this.accountKeysFromLookups = accountKeysFromLookups;
  }
  _createClass__default.default(MessageAccountKeys, [{
    key: "keySegments",
...
var CompiledKeys = /*#__PURE__*/function () {
  function CompiledKeys(payer, keyMetaMap) {
    _classCallCheck__default.default(this, CompiledKeys);
    this.payer = void 0;
    this.keyMetaMap = void 0;
    this.payer = payer;
    this.keyMetaMap = keyMetaMap;
  }
  _createClass__default.default(CompiledKeys, [{
    key: "getMessageComponents",
    value: function getMessageComponents() {
      var mapEntries = _toConsumableArray__default.default(this.keyMetaMap.entries());
      ...
      // sanity checks
      {
        ...
        var _writableSigners$ = _slicedToArray__default.default(writableSigners[0], 1),
          payerAddress = _writableSigners$[0];
        assert(payerAddress === this.payer.toBase58(), 'Expected first writable signer key to be the fee payer');
      }
      var staticAccountKeys = [].concat(_toConsumableArray__default.default(writableSigners.map(function (_ref9) {
        var _ref10 = _slicedToArray__default.default(_ref9, 1),
          address = _ref10[0];
        return new PublicKey(address);
      })), _toConsumableArray__default.default(readonlySigners.map(function (_ref11) {
        var _ref12 = _slicedToArray__default.default(_ref11, 1),
          address = _ref12[0];
        return new PublicKey(address);
      })), _toConsumableArray__default.default(writableNonSigners.map(function (_ref13) {
        var _ref14 = _slicedToArray__default.default(_ref13, 1),
          address = _ref14[0];
        return new PublicKey(address);
      })), _toConsumableArray__default.default(readonlyNonSigners.map(function (_ref15) {
        var _ref16 = _slicedToArray__default.default(_ref15, 1),
          address = _ref16[0];
        return new PublicKey(address);
      })));
    ...
    value: function extractTableLookup(lookupTable) {
      var _this$drainKeysFoundI = this.drainKeysFoundInLookupTable(lookupTable.state.addresses, function (keyMeta) {
        ...
        _this$drainKeysFoundI2 = _slicedToArray__default.default(_this$drainKeysFoundI, 2),
      ...
      var _this$drainKeysFoundI3 = this.drainKeysFoundInLookupTable(lookupTable.state.addresses, function (keyMeta) {
        ...
        _this$drainKeysFoundI4 = _slicedToArray__default.default(_this$drainKeysFoundI3, 2),
...
var Message = /*#__PURE__*/function () {
  ...
  _createClass__default.default(Message, [{
    ...
    value: function programIds() {
      return _toConsumableArray__default.default(this.indexToProgramIds.values());
    }
  }, {
    key: "nonProgramIds",
    ...
    value: function compile(args) {
      ...
      var _compiledKeys$getMess = compiledKeys.getMessageComponents(),
        _compiledKeys$getMess2 = _slicedToArray__default.default(_compiledKeys$getMess, 2),
    ...
    value: function from(buffer$1) {
      // Slice up wire data
      var byteArray = _toConsumableArray__default.default(buffer$1);
...
var MessageV0 = /*#__PURE__*/function () {
  function MessageV0(args) {
    _classCallCheck__default.default(this, MessageV0);
    this.header = void 0;
    this.staticAccountKeys = void 0;
    this.recentBlockhash = void 0;
  ...
  _createClass__default.default(MessageV0, [{
    key: "version",
    get: function get() {
      return 0;
    }
      ...
      try {
        for (_iterator7.s(); !(_step7 = _iterator7.n()).done;) {
          ...
          if (extractResult !== undefined) {
            ...
            var _extractResult = _slicedToArray__default.default(extractResult, 2),
            ...
            (_accountKeysFromLooku = accountKeysFromLookups.writable).push.apply(_accountKeysFromLooku, _toConsumableArray__default.default(writable));
            (_accountKeysFromLooku2 = accountKeysFromLookups.readonly).push.apply(_accountKeysFromLooku2, _toConsumableArray__default.default(readonly));
          }
        }
      } catch (err) {
        _iterator7.e(err);
    ...
    value: function deserialize(serializedMessage) {
      var byteArray = _toConsumableArray__default.default(serializedMessage);
      ...
      var recentBlockhash = bs58__default.default.encode(byteArray.splice(0, PUBLIC_KEY_LENGTH));
      var instructionCount = decodeLength(byteArray);
...
var TransactionInstruction = /*#__PURE__*/function () {
   ...
   * @internal
   */
  _createClass__default.default(TransactionInstruction, [{
    key: "toJSON",
    value: function toJSON() {
      return {
        ...
        data: _toConsumableArray__default.default(this.data)
      };
    }
  }]);
    ...
    value: function compileMessage() {
      ...
      if (this.nonceInfo) {
        ...
        if (this.instructions[0] != this.nonceInfo.nonceInstruction) {
          instructions = [this.nonceInfo.nonceInstruction].concat(_toConsumableArray__default.default(this.instructions));
        } else {
...
var TransactionMessage = /*#__PURE__*/function () {
  function TransactionMessage(args) {
    _classCallCheck__default.default(this, TransactionMessage);
  ...
  _createClass__default.default(TransactionMessage, [{
...
var VersionedTransaction = /*#__PURE__*/function () {
  function VersionedTransaction(message, signatures) {
    _classCallCheck__default.default(this, VersionedTransaction);
  ...
  _createClass__default.default(VersionedTransaction, [{
    key: "version",
    get: function get() {
    ...
    value: function deserialize(serializedTransaction) {
      var byteArray = _toConsumableArray__default.default(serializedTransaction);
      var signatures = [];
...
var EpochSchedule = /*#__PURE__*/function () {
  function EpochSchedule(slotsPerEpoch, leaderScheduleSlotOffset, warmup, firstNormalEpoch, firstNormalSlot) {
    _classCallCheck__default.default(this, EpochSchedule);
  ...
  _createClass__default.default(EpochSchedule, [{
    key: "getEpoch",
...
var SendTransactionError = /*#__PURE__*/function (_Error) {
  _inherits__default.default(SendTransactionError, _Error);
  var _super = _createSuper$1(SendTransactionError);
  function SendTransactionError(message, logs) {
    var _this;
    _classCallCheck__default.default(this, SendTransactionError);
    _this = _super.call(this, message);
    _this.logs = void 0;
    _this.logs = logs;
    return _this;
  }
  return _createClass__default.default(SendTransactionError);
}( /*#__PURE__*/_wrapNativeSuper__default.default(Error));
...
var SolanaJSONRPCError = /*#__PURE__*/function (_Error2) {
  _inherits__default.default(SolanaJSONRPCError, _Error2);
  ...
  function SolanaJSONRPCError(_ref, customMessage) {
    ...
    var code = _ref.code,
      ...
      data = _ref.data;
    _classCallCheck__default.default(this, SolanaJSONRPCError);
    ...
    return _regeneratorRuntime$2().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          ...
          _context.next = 3;
          return nodeFetch__namespace["default"](processedInput, init);
        case 3:
...
var RpcWebSocketClient = /*#__PURE__*/function (_RpcWebSocketCommonCl) {
  _inherits__default.default(RpcWebSocketClient, _RpcWebSocketCommonCl);
  var _super = _createSuper(RpcWebSocketClient);
  function RpcWebSocketClient(address, options, generate_request_id) {
    var _this;
    _classCallCheck__default.default(this, RpcWebSocketClient);
    var webSocketFactory = function webSocketFactory(url) {
      var rpc = WebsocketFactory__default.default(url, _objectSpread$1({
        autoconnect: true,
        max_reconnects: 5,
        reconnect: true,
  ...
  _createClass__default.default(RpcWebSocketClient, [{
    key: "call",
    value: function call() {
      ...
      if (readyState === 1 /* WebSocket.OPEN */) {
        var _get2;
        return (_get2 = _get__default.default(_getPrototypeOf__default.default(RpcWebSocketClient.prototype), "call", this)).call.apply(_get2, [this].concat(args));
      }
    ...
    value: function notify() {
      ...
      if (readyState === 1 /* WebSocket.OPEN */) {
        var _get3;
        return (_get3 = _get__default.default(_getPrototypeOf__default.default(RpcWebSocketClient.prototype), "notify", this)).call.apply(_get3, [this].concat(args));
      }
      return Promise.reject(new Error('Tried to send a JSON-RPC notification `' + args[0] + '` but the socket was not `CONNECTING` or `OPEN` (`readyState` was ' + readyState + ')'));
    }
  }]);
  return RpcWebSocketClient;
}(RpcWebSocketCommonClient__default.default);
...
var AddressLookupTableAccount = /*#__PURE__*/function () {
  function AddressLookupTableAccount(args) {
    _classCallCheck__default.default(this, AddressLookupTableAccount);
    this.key = void 0;
    this.state = void 0;
    this.key = args.key;
    this.state = args.state;
  }
  _createClass__default.default(AddressLookupTableAccount, [{
    key: "isActive",
    ...
    value: function deserialize(accountData) {
      ...
      var _BufferLayout$struct$ = BufferLayout__namespace.struct([BufferLayout__namespace.seq(publicKey(), numSerializedAddresses, 'addresses')]).decode(accountData.slice(LOOKUP_TABLE_META_SIZE)),
...
function makeWebsocketUrl(endpoint) {
  ...
  var _matches = _slicedToArray__default.default(matches, 4);
    _matches[0];
...
function extractCommitmentFromConfig(commitmentOrConfig) {
  ...
  if (typeof commitmentOrConfig === 'string') {
    ...
    var specifiedCommitment = commitmentOrConfig.commitment,
      specifiedConfig = _objectWithoutProperties__default.default(commitmentOrConfig, _excluded);
        ...
        return _regeneratorRuntime$1().wrap(function _callee$(_context) {
          while (1) switch (_context.prev = _context.next) {
            ...
            case 2:
              ...
              _context.next = 5;
              return fetch.apply(void 0, _toConsumableArray__default.default(modifiedFetchArgs));
            case 5:
              return _context.abrupt("return", _context.sent);
            case 6:
            case "end":
  ...
  _createClass__default.default(Connection, [{
        ...
        return _regeneratorRuntime$1().wrap(function _callee24$(_context24) {
          while (1) switch (_context24.prev = _context24.next) {
            case 0:
              ...
              _ref5 = config || {}, encoding = _ref5.encoding, configWithoutEncoding = _objectWithoutProperties__default.default(_ref5, _excluded2);
          ...
          while (1) switch (_context65.prev = _context65.next) {
            case 0:
              if (typeof configOrCommitment === 'string') {
                ...
                c = configOrCommitment.commitment, rest = _objectWithoutProperties__default.default(configOrCommitment, _excluded3);
                commitment = c;
                extra = rest;
              }
        ...
        return _regeneratorRuntime$1().wrap(function _callee86$(_context87) {
          while (1) switch (_context87.prev = _context87.next) {
            ...
            case 20:
              ...
              (_transaction = transaction).sign.apply(_transaction, _toConsumableArray__default.default(signers));
              _context87.next = 45;
              break;
            case 25:
            ...
            case 33:
              (_transaction2 = transaction).sign.apply(_transaction2, _toConsumableArray__default.default(signers));
    ...
    value: function _handleServerNotification(serverSubscriptionId, callbackArgs) {
      ...
      callbacks.forEach(function (cb) {
        try {
          cb.apply(void 0, _toConsumableArray__default.default(callbackArgs));
        } catch (e) {
          console.error(e);
        }
      });
    ...
    value: function _wsOnAccountNotification(notification) {
      var _create = superstruct.create(notification, AccountNotificationResult),
    ...
    value: function _wsOnProgramAccountNotification(notification) {
      var _create2 = superstruct.create(notification, ProgramAccountNotificationResult),
    ...
    value: function onLogs(filter, callback, commitment) {
      var args = this._buildArgs([_typeof__default.default(filter) === 'object' ? {
    ...
    value: function _wsOnLogsNotification(notification) {
      var _create3 = superstruct.create(notification, LogsNotificationResult),
    ...
    value: function _wsOnSlotNotification(notification) {
      var _create4 = superstruct.create(notification, SlotNotificationResult),
    ...
    value: function _wsOnSlotUpdatesNotification(notification) {
      var _create5 = superstruct.create(notification, SlotUpdateNotificationResult),
    ...
    value: function _wsOnSignatureNotification(notification) {
      var _create6 = superstruct.create(notification, SignatureNotificationResult),
    ...
    value: function onSignatureWithOptions(signature, _callback2, options) {
      ...
      var _options$commitment = _objectSpread(_objectSpread({}, options), {}, {
        ...
        extra = _objectWithoutProperties__default.default(_options$commitment, _excluded4);
    ...
    value: function _wsOnRootNotification(notification) {
      var _create7 = superstruct.create(notification, RootNotificationResult),
...
var Keypair = /*#__PURE__*/function () {
  ...
  function Keypair(keypair) {
    _classCallCheck__default.default(this, Keypair);
   ...
   */
  _createClass__default.default(Keypair, [{
    key: "publicKey",
    get:
    /**
...
var AddressLookupTableInstruction = /*#__PURE__*/function () {
  ...
  function AddressLookupTableInstruction() {
    _classCallCheck__default.default(this, AddressLookupTableInstruction);
  }
  _createClass__default.default(AddressLookupTableInstruction, null, [{
    key: "decodeInstructionType",
    value: function decodeInstructionType(instruction) {
      this.checkProgramId(instruction.programId);
      var instructionTypeLayout = BufferLayout__namespace.u32('instruction');
...
var AddressLookupTableProgram = /*#__PURE__*/function () {
  ...
  function AddressLookupTableProgram() {
    _classCallCheck__default.default(this, AddressLookupTableProgram);
  }
  _createClass__default.default(AddressLookupTableProgram, null, [{
    ...
    value: function createLookupTable(params) {
      var _PublicKey$findProgra = PublicKey.findProgramAddressSync([params.authority.toBuffer(), bigintBuffer.toBufferLE(BigInt(params.recentSlot), 8)], this.programId),
        _PublicKey$findProgra2 = _slicedToArray__default.default(_PublicKey$findProgra, 2),
...
var ComputeBudgetInstruction = /*#__PURE__*/function () {
  ...
  function ComputeBudgetInstruction() {
    _classCallCheck__default.default(this, ComputeBudgetInstruction);
  }

  /**
   * Decode a compute budget instruction and retrieve the instruction type.
   */
  _createClass__default.default(ComputeBudgetInstruction, null, [{
    key: "decodeInstructionType",
    value: function decodeInstructionType(instruction) {
      this.checkProgramId(instruction.programId);
...
var ComputeBudgetProgram = /*#__PURE__*/function () {
  ...
  function ComputeBudgetProgram() {
    _classCallCheck__default.default(this, ComputeBudgetProgram);
  }

  /**
   * Public key that identifies the Compute Budget program
   */
  _createClass__default.default(ComputeBudgetProgram, null, [{
    key: "requestUnits",
    value:
    /**
...
var Ed25519Program = /*#__PURE__*/function () {
  ...
  function Ed25519Program() {
    _classCallCheck__default.default(this, Ed25519Program);
  }

  /**
   * Public key that identifies the ed25519 program
   */
  _createClass__default.default(Ed25519Program, null, [{
    ...
    value: function createInstructionWithPrivateKey(params) {
      ...
      try {
        ...
        var _ecdsaSign = ecdsaSign(messageHash, privateKey),
          _ecdsaSign2 = _slicedToArray__default.default(_ecdsaSign, 2),
 ...
 */
var Authorized = /*#__PURE__*/_createClass__default.default(
/**
 ...
 */
var Lockup = /*#__PURE__*/_createClass__default.default(
/**
 ...
 * Vote account info
 */
var VoteInit = /*#__PURE__*/_createClass__default.default( /** [0, 100] */

function VoteInit(nodePubkey, authorizedVoter, authorizedWithdrawer, commission) {
  _classCallCheck__default.default(this, VoteInit);
...
var VoteInstruction = /*#__PURE__*/function () {
  ...
  function VoteInstruction() {
    _classCallCheck__default.default(this, VoteInstruction);
  }

  /**
   * Decode a vote instruction and retrieve the instruction type.
   */
  _createClass__default.default(VoteInstruction, null, [{
    key: "decodeInstructionType",
    value: function decodeInstructionType(instruction) {
      this.checkProgramId(instruction.programId);
      var instructionTypeLayout = BufferLayout__namespace.u32('instruction');
...
var VoteProgram = /*#__PURE__*/function () {
  ...
  function VoteProgram() {
    _classCallCheck__default.default(this, VoteProgram);
  }

  /**
   * Public key that identifies the Vote program
   */
  _createClass__default.default(VoteProgram, null, [{
...
function getPriorVoters(_ref3) {
  ...
  return [].concat(_toConsumableArray__default.default(buf.slice(idx + 1).map(parsePriorVoters)), _toConsumableArray__default.default(buf.slice(0, idx).map(parsePriorVoters)));
}
