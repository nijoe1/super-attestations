...
export type RpcBlock<TBlockTag extends BlockTag = BlockTag, TIncludeTransactions extends boolean = boolean> = Block<Quantity, TIncludeTransactions, TBlockTag, RpcTransaction<TBlockTag extends 'pending' ? true : false>>;
